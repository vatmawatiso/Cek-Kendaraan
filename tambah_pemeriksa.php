                    ...
                    <div class="card">
                        <div class="card-body">
                            <div style="display: flex; justify-content: space-between;">
                                ...
                                <a href="index.php" class="btn btn-success" style="font-weight: bold; height: 40px; margin-top:10px">Kembali</a>
                            </div>
                            ...
                            <form action="" method="post">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nm_pemeriksa" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Nama Pengemudi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nm_pengemudi" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="jenis_kendaraan" required><br>
                                    </div>
                                </div>

                                <div class="text-center">
                                    <input style="font-weight: bold;" type="submit" name="submit" value="Simpan" class="btn btn-primary" />
                                </div>
